        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {categories.map((category, index) => (
            ...
            >
              ...
              />
              <p className="text-xl font-semibold mt-4 relative bg-black hover:bg-slate-900 transition-all duration-300 w-1/2 hover:w-2/3 hover:rounded-4xl py-4 text-white -top-32 left-32">
                {category.name}
              </p>
            </Link>
          ))}
